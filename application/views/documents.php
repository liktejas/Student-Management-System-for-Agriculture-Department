...
<head>
  ...
  <title>Add Student Documents</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <!-- <li class="active"><a href="<?php //echo base_url(); ?>docs"><i class="fa fa-file-text"></i> <span>Add Student Documents</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Admission Documents</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <!-- <div class="container"> -->
        ...
        <!-- <div class="col-12"> -->
          <div class="col-md-12"><h1>Add Admission Documents</h1></div>
          <!-- <div class="table-responsive"> -->
            <form action="Main/add_data" method="POST" enctype="multipart/formdata">
              <label for="rollno">Roll No. :</label>
              <input type="textbox" class="form-group" name="rollno" placeholder="Enter Roll No." autocomplete="off" id="rollno" required>&emsp;
              <label for="regno">Registration No. :</label>
              <input type="textbox" class="form-group" name="regno" placeholder="Enter Registration No." autocomplete="off" id="regno" required>&emsp;
              <label for="name">Name :</label>
              <input type="textbox" class="form-group" name="name" placeholder="Enter Name" autocomplete="off" id="name" size="50" required>
              <table class="table table-bordered table-responsive" style="background-color: #FFFFFF">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <p><input type="radio" name="c1" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c1" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c2" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c2" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c3" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c3" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c4" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c4" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c5" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c5" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c6" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c6" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c7" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c7" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c8" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c8" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c9" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c9" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c10" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c10" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c11" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c11" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c12" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c12" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c13" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c13" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c14" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c14" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c15" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c15" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p><input type="radio" name="c16" value="होय" class="minimal" required>होय &emsp;<input type="radio" name="c16" value="नाही" class="minimal" required>नाही</p>
                    </td>
                  </tr>
                </tbody>
              </table>
              <!-- <div class="col-md-6"> -->
                <center><input type="submit" name="submitt" value="Submit" class="btn btn-primary"></center>
                <!-- </div> -->
              </form>
