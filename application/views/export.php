  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href="<?php echo base_url(); ?>export"><i class="fa fa-table"></i> <span>Student Exportable Data</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Exportable Data</li>
      </ol>
    </section>
      ...
      <!-- <div class="container"> -->
        ...
        <!-- <div class="row"> -->
          <div class="col-12">
              ...
              <h1>Student Exportable Data<div class="btn pull-right"><a href="" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Add Student</a></div></h1>
              <!-- <div class="col-md-12"> -->
                ...
                foreach ($students as $row)
                {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?php echo base_url()."Main/view_student_info/".$row->id; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                      ...
                      <a href="<?php echo base_url()."Main/delete/".$row->id; ?>" class="btn btn-danger" onclick="return confirmDelete();"><i class="fa fa-trash"></i></a>
        ...
        <form id="add_form" method="POST" enctype="multipart/formdata" action="Main/student_save">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group row">
                    <label class="col-md-2 col-form-label">Roll No. </label>
                    <div class="col-md-10">
                      <input type="text" name="rollno" id="rollno" class="form-control" placeholder="Roll No." autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                      <input type="text" name="regno" id="regno" class="form-control" placeholder="Registration No." autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="input-group date">  
                            ...
                            <div class="col-md-12">
                              <input type="text" class="form-control" name="dob" id="datepicker" placeholder="Date of Birth (DD/MM/YYYY)" autocomplete="off" required>
                            </div>
                          </div>
                          <!-- /.input group -->
                        </div>
                        ...
                        <!-- radio -->
                        <div class="form-group row">
                         <label class="col-md-2 col-form-label">Gender<font class="text-danger">*</font>
                         </label>
                         <label>
                          <input type="radio" name="gender" class="minimal" id="male" value="पुरुष" required> पुरुष
                        </label>
                        <label>
                          <input type="radio" name="gender" class="minimal" id="female" value="महिला" required> महिला
                        </label>
                        
                      </div>

                      <div class="form-group row">
                        <label class="col-md-2 col-form-label">Address <font class="text-danger">*</font></label>
                        <div class="col-md-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <input type="text" name="contact" id="contact"  class="form-control" placeholder="Contact Number" autocomplete="off" required>
                        </div>
                      </div>
                    ...
                    <div class="modal-footer">
                      <p style="margin-right:85%; ">'<font class="text-danger">*</font>' are mandatory</p>
