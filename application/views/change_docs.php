...
<head>
  ...
  <title>Student Document List</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-info"></i> <span>Detailed Student L.C.</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
    ...
    <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Admission Documents</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <!-- <div class="container"> -->
        ...
        <!-- <div class="row"> -->
          <!-- <div class="col-12"> -->
            <div class="col-md-12">
              <h1 class="">Edit Admission Documents
                <!-- <small>List</small> -->
              ...
              <table class="table table-bordered table-striped table-hover" id="mydata">
                ...
                foreach ($documents as $row)
                {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url()."Main/view_doc_info/".$row->id; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                      <a href="<?php echo base_url()."Main/doc_edit/".$row->id; ?>" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                      <!-- In view docs, info is fetched by $row->rollno, where rollno is common bet student and document table  -->
                      <a href="<?php echo base_url()."Main/delete_doc/".$row->id; ?>" class="btn btn-danger" onclick="return confirmDelete();"><i class="fa fa-trash"></i></a>
